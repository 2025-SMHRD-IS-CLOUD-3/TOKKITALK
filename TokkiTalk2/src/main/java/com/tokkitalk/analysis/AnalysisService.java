        ...
        if (result == null) {
            ...
            if (inputText.contains("괜찮아") || inputText.contains("괜찮다고")) {
                ...
                rs.alternatives = Arrays.asList(
                    "괜찮다고 하지만 표정이 안 괜찮아 보여. 옆에 있어도 될까?",
                ...
                rs.alternatives = Arrays.asList(
                    "알아서 하기보다는 네 의견이 궁금해. 어떻게 생각해?",
                    "알아서 하라니까 세가지 대안을 줄게, 선택해줄래?",
                ...
                rs.alternatives = Arrays.asList(
                    "둘 다 각자 매력이 있지만 내 마음은 정해져 있어",
                    "친구든 누구든 너만큼 예쁜 사람은 없어",
                ...
                rs.alternatives = Arrays.asList(
                    "화 안 났다고 해도 내가 뭔가 잘못한 것 같아. 미안해",
                    "화 났든 안 났든 일단 얘기해보자. 뭐가 문제야?",
